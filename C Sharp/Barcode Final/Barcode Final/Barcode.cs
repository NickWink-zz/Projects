...
namespace Barcode_Final
{
    public class Code39Control : Control
    {
        ...
        private void DrawBarcode(Graphics insGraphics)
        {
            ...
            string copyText = this.Text.ToUpper();
        ...
        void _ContextMenuStrip_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
            ...
            else if (e.ClickedItem.Text == "Export")
            {
                ...
                string tex = this.Text.ToUpper();
                sfd.ShowDialog();
                if (sfd.FileName != "")
                {
                    string t = this.Text.ToUpper();

                    StringFormat sFormat = new StringFormat();
                    sFormat.Alignment = StringAlignment.Center;
                    sFormat.LineAlignment = StringAlignment.Center;
                    Rectangle rect = new Rectangle(300, 275, 100, 100);
                    ...
                    //a.Graphics.DrawString(tex, new Font("Arial", 12), Brushes.Black, rect, sFormat);
        ...
        void p_PrintPage(object sender, PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawImage(i, new Point(150, 100));
            e.Graphics.DrawString(tex, new Font("Arial", 12), Brushes.Black, rect, sFormat);
